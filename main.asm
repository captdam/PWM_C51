...
INI:
	...
	MOV R0, A			;Get Id * 20
	ADD A, #0x80			;Add 128
	MOV R4, A			;Get base address, PWM at R4 to R4 + 15, On/OFF at R4 + 16 to R4 + 19
	;Enable interupt
...
PROCESS_P12:
	MOV A, R4			;Pointer fot input data in RAM (ini: base address)
...
PROCESS_MERGEPWM:
	...
	CJNE R0, #0x6F, PROCESS_READ	;Last one 0x70 (P0), dec then it should be 0x6F
...
PROCESS_MAPPWM:
	...
	MOV R1, #0xFF			;Ini status of PWM, all high
